...
public class BaseClass {
	...
	public void setUp(String os,String br) throws IOException {
		...
		driver=new RemoteWebDriver(new URL("http://192.168.29.24:4444/wd/hub"), capabilities);
			}
...
@AfterClass(groups = {"sanity","Regression","Master","Datadriver"})
	...
	public String randomAlphaNumaric() {
		...
		String generatedNumberString=RandomStringUtils.randomAlphanumeric(10);
		return(generatedString+generatedNumberString);
	}
	...
	String targeFilePath=System.getProperty("user.dir")+"\\screenshorts\\"+tname+"_"+timeStamp+".png";
